node{
    ...
    stage('Publishing Image to DockerHub'){
        ...
        withCredentials([usernamePassword(credentialsId: '68389459-7514-49a6-bd5c-4cd998f41667', usernameVariable: 'DOCKER_USER', passwordVariable: 'DOCKER_PASS')]) {
